...
!!! info "**Importante**"
    El lugar aconsejable para añadir código JavaScript directamente en HTML es:

    - Justo antes de la etiqua `<\body>`
        ```html
        <!DOCTYPE html>
        <html>
            <body>
...
!!! info "**Importante**"
    El lugar aconsejable para integrar un archivo JavaScript externo es:

    - En la etiqueta `<head>` añadiendo la propiedad `defer`:
    ...
    console.log("Se ha ejecuta el fichero JavaScript");
    ```