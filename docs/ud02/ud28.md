...
### 8.2.1 Ejercicios condición IF - Tanda_1
...
### 8.2.3 Ejercicios condición IF - Tanda_2
...
#### 8.4.2.1 Ejercicios Bucle `while` Tanda_1
...
??? note "Ejercicios estructura `while`"
    ...
    !!! question "Ejercicio 6"
        ...
        ??? tip "Solución"
            ...
            ```
#### 8.4.2.1 Ejercicios Bucle `while` Tanda_2
...
#### 8.4.2.1 Ejercicios Bucle `while` Tanda_3
