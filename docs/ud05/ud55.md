...
!!! note "Ejercicios: Eventos de teclado Parte_1"
        ...
        === "app.js"
            ...
            /*
                ENUNCIADO: Crear un evento a toda la página web. El evento se ejecutará cuando se mantenga pulsada una tecla.
                 ...
                 Deben aparecer todas las teclas pulsadas, no solo la última que se ha pulsado. Además:
                    a) Si se pulsa la letra 'r', todo el texto de la variable 'caja' aparecerá de color 'rojo'.
                    b) Si se pulsa la letra 'v', todo el texto de la variable 'caja' aparecerá de color 'verde'.
                    c) Si se pulsa la letra 'a', todo el texto de la variable 'caja' aparecerá de color 'azul'.
            */
            ```
    ...
    ??? example "Ejercicio 3: Escribe rápido"
        ...
        === "app.js"
            ...
            function nuevaLetra() {
                actual = abecedario[Math.floor(Math.random() * abecedario.length)];
            ...
            /*
                ...
                La funcionalidad del evento será la siguiente:
                    - Si la tecla pulsada es igual a variable 'actual':
                      1) Se sumará un punto a la variable 'puntos'
                      2) Se asignará a la propiedad textContent de la variable 'letra' un mensaje donde aparezcan los puntos conseguidos.
                      3) Se escribirá la siguiente sentencia: nuevaLetra()
            */   
