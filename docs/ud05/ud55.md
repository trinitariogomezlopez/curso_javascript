...
!!! note "Ejercicios: Eventos de teclado Parte_1"
            ...
            /*
                ENUNCIADO: Añadir un evento a toda la página web de forma que cuando se mantenga pulsada una de las cuatro flechas se deben realizar las siguientes tareas:
                    ...
                    5) Finalmente asignar a la variable caja los sigientes estilos:
                          1) caja.style.left = x + "px";
                          2) caja.style.top = y + "px";
            */
        ...
        === "app.js"
            ...
            /*
                ENUNCIADO: Crear un evento a toda la página web. El evento se ejecutará cuando se mantenga pulsada una tecla.
                 Cuando se pulse una tecla, la letra de la tecla pulsada aparecerá en el elemento con id="caja". Deben aparecer todas las teclas pulsadas, no solo la última que se ha pulsado. Además:
                    a) Si se pulsa la letra 'r', todo el texto que aparece en el elemento con id='caja' aparecerá de color 'rojo'.
                    b) Si se pulsa la letra 'v', todo el texto que aparece en el elemento con id='caja' aparecerá de color 'verde'.
                    c) Si se pulsa la letra 'a', todo el texto que aparece en el elemento con id='caja' aparecerá de color 'azul'.
            */
            ```
    ...
    ??? example "Ejercicio 3: Escribe rápido"
        ...
        === "app.js"
            ...
            /*
                ENUNCIADO: Crear un evento sobre toda la página web. El evento se ejecutará cuando se mantenga pulsada una tecla.
                La funcionalidad del evento será la siguiente:
                    - Si la tecla pulsada es igual a la variable 'actual':
                      1) Se sumará un punto a la variable 'puntos'
                      2) Se mostrará en el elemento con id = "letra" un mensaje donde aparezcan los puntos conseguidos.
                      3) Se invocará a función 'nuevaLetra()'
            */   
    ...
    !!! example "Ejercicio 4: Hacer una calculadora científica que permita hacer sumas, restas, multiplicaciones y divisiones entre dos números"
