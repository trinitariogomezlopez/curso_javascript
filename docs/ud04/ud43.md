    ...
    ??? example "Ejercicio 5: Control de pedidos en tienda. Calcular la venta de diversos pedidos de una tienda. El total se calculará sumando todos los precios de cada venta, además, se podrá aplicar un porcentaje de descuento sobre el total."
        ...
        === "app.js"
            ...
            function calcular() {
                ...
                // 1. Obtener todos los input que contengan la clase class = "precios" empleando querySelectorAll("#pedidos .precio"). Guardar todos los inputs en la variable 'precios'.
                ...
                // 3. Obtener el descuento con querySelector("#descuento") y almacenarlo en la variable 'descuento'.
        ...
        === "SOLUCIÓN"
            ...
            function calcular() {
                ...
                // 1. Obtener todos los input que contengan la clase class = "precios" empleando querySelectorAll("#pedidos .precio"). Guardar todos los inputs en la variable 'precios'.
                precios = document.querySelectorAll("#pedidos .precio");
    ...
    ??? example "Ejercicio 6: Reserva de hotel. Completar el fichero app.js para que calcule el precio de la reserva de una habitación de hotel. El precio de la comida dependerá si el cliente es 'Normal' o 'VIP'. Si el cliente es 'Normal' el precio final será la suma de los precios de cada noche, sin embargo, si el cliente es 'VIP', al precio total se le descontará un 10%. Además, se puede aplicar un descuento al precio final (total - (total * descuelto / 100))."
        ...
        === "app.js"
            ...
            function calcular() {
                ...
                // 1. Obtener todos los input que tengan la clase class = 'precios' con querySelectorAll("#habitaciones .precio"). Almacenar todos los input en la variable 'precios'.

                // 2. Recorrer todos los precios y obtener la suma de todos ellos. Guardar el resultado en la variable 'total'.

                // 3. Obtener todos los tipos de clientes con querySelectorAll(".cliente") y almacenarlos en la variable 'clientes'.

                // 4. Recorrer todos los tipos de clientes y guardar el value del cliente que está chequeado en la variable 'tipo'
                /* 
                ...
                */
                ...
                // 5. Si el tipo de clientes es igual a 'vip', aplicar al total un 10% de descuento mediante la fórmula 'total * 0.9'. Almacenar el resultado en la variable 'total'.

                // 6. Obtener el descuento con getElementById y almacenarlo en la variable 'descuento'.

                // 7. Aplicar al total el descuento obtenido mediante la fórmula: (total - (total * descuento / 100)). Almacenar la fórmula en la variable 'total'.
        ...
        === "SOLUCIÓN"
            ...
            function calcular() {
                ...
                // 1. Obtener todos los input que tengan la clase class = 'precios' con querySelectorAll("#habitaciones .precio"). Almacenar todos los input en la variable 'precios'.
                precios = document.querySelectorAll("#habitaciones .precio");
    ...
    ??? example "Ejercicio 8: Cita médica con servicios. Completar el fichero app.js para que calcule el precio de una visita médico. El precio final dependerá del tipo de seguro mético. Si el tipo de seguro es 'público' se pagará la mitad del precio total de todos los servicios utilizados, pero si el seguro es 'privado', se pagará de forma completa todos los servicios utilizados."
        ...
        === "app.js"
            ...
            function calcularTotal() {
                ...
                // 1. Obtene el elemento con el id = 'Servicios' (getElementById) y almacenarlo en la variable 'contenedor'

                // 2. Obtener todos los input hijos de la variable contenedor a partir del nombre del tag = 'input' (getElementsByTagName). Almacenar los input e la variable 'inputs'
                ...
                // 4. Obtener todos los seguros a partir del 'name = seguro' (getElementsByName) y almacenarlo en la variable 'seguros'.
        ...
        === "SOLUCIÓN"
            ...
            function calcularTotal() {
                ...
                // 1. Obtene el elemento con el id = 'Servicios' (getElementById) y almacenarlo en la variable 'contenedor'
                contenedor = document.getElementById("servicios");
                ...
                // 4. Obtener todos los seguros a partir del 'name = seguro' (getElementsByName) y almacenarlo en la variable 'seguros'.
                seguros = document.getElementsByName("seguro");
    ...
    ??? example "Ejercicio 9: Pedido en restaurante. Completar el fichero app.js para que calcule el precio de una comida. El precio de la comida dependerá si el comensal come en el local y a domicilio. Si el comensal come en el local, el precio total será la suma del 'menú + bebida + postre', pero si come a domicilio se sumarán 3 euros al precio final. Además, se puede dejar propina, la cual se sumará al total a pagar."
        ...
        === "app.js"
            ...
            function calcularPedido() {
                ...
                // 1. Obtene el elemento con el id = 'platos' y almacenarlo en la variable 'contenedor.

                // 2. Obtener todos los input hijos de la variable 'contenedor' a partir del nombre del tag = 'input' (getElementsByTagName)

                // 3. Calcular el precio total. Para ello se deben recorrer todos los input y obtener su valor (value).
                // El precio total es igual a la suma de todos los precios. Almacenar la suma en la variable 'total'.

                // 4. Obtener el valor de la propina a partir del id='propina', y almacenar el valor en una variable llamada 'propina'.

                // 5. Suma la propina al total (total + propina) y almacenar el valor en la variable 'total'.

                // 6. Obtener todos los servicios a partir del 'name = servicio' (getElementsByName) y almacenarlos en la varibale 'servicios'
        ...
        === "SOLUCIÓN"
            ...
            function calcularPedido() {
                ...
                // 1. Obtene el elemento con el id = 'platos' y almacenarlo en la variable 'contenedor.
                contenedor = document.getElementById("platos");
                ...
                // 4. Obtener el valor de la propina a partir del id='propina', y almacenar el valor en una variable llamada 'propina'.
                propina = parseFloat(document.getElementById("propina").value);

                // 5. Suma la propina al total (total + propina) y almacenar el valor en la variable 'total'.
                total = total + propina;

                // 6. Obtener todos los servicios a partir del 'name = servicio' (getElementsByName) y almacenarlos en la varibale 'servicios'
                servicios = document.getElementsByName("servicio");
