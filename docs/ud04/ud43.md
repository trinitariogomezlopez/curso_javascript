...
??? example "Ejemplo 3: Acceder atributos en input - radio"
    === "index.html"
...
??? example "Ejemplo 4: Acceder atributos en input - checkbox"
    === "index.html"
...
??? example "Ejemplo 5: Acceder atributos en input - select"
    === "index.html"
    ...
    === "app.js"
        ...
        function mostrar() {
            ...
            lista = document.querySelector("#ciudad");
...
!!! note "Ejercicios input: checkbox"
    ...
    ??? example "Ejercicio 1: Calcular precio con extras"
    ...
    ??? example "Ejercicio 2: Mostrar opciones seleccionadas con estilo"
...
!!! note "Ejercicios input: select"
    ...
    ??? example "Ejercicio 1: Calcular precio según opción"
        ...
        === "app.js"
            ...
            function calcular() {
                ...
                // 1. Obtener el elemento <select id="producto"> y asignarlo a la variable lista

                // 2. Asignar a la variable opciones, todas las opciones de la variable 'lista'.

                // 3. Recorrer todas las opciones y asignar a la variable 'precio' el valor (value) de la opción seleccionada.

                // 4. Mostrar el mensaje: "Precio " + precio + " €", en el elemento <p id="resultado"></p>
            }
            ```
        ...
        === "SOLUCIÓN"
            ...
            function calcular() {
                ...
                // 1. Obtener el elemento <select id="producto"> y asignalo a la variable lista
                lista = document.querySelector("#producto");
                ...
                {
                    if (opciones[i].selected) {
                        precio = parseInt(opciones[i].value);
                    }
    ...
    ??? example "Ejercicio 2: Cambiar estilo según selección"
        ...
        === "app.js"
            ...
            ```javascript
            function cambiar() {
                let lista, opciones, texto;
                let i = 0;
                let color="";

                // 1. Obtener el elemento <select id="color"> y asignalo a la variable lista

                // 2. Asignar a la variable opciones, todas las opciones de la variable 'lista'.

                // 3. Recorrer todas las opciones y asignar a la variable 'color' el valor (value) de la opción seleccionada.

                // 4. Asignar el elemento <p id="texto">Texto de ejemplo</p> a la variable 'texto'

                // 5. Si la variable 'color' es igual a "", asignar a la variable 'texto', el mensaje: "No has seleccionado color" y el color: "black", 
        ...
        === "SOLUCIÓN"
            ...
            function cambiar() {
                ...
                // 1. Obtener el elemento <select id="color"> y asignalo a la variable lista
                lista = document.querySelector("#color");
...
!!! note "Ejercicios input: radio - checkbox - select"
    ...
    ??? example "Ejercicio 1: Reserva con tipo de habitación (select)"
        ...
        === "app.js"
            ...
            function calcular() {
                ...
                // 3. Obtener el elemento <select id="habitacion"> y asignalo a la variable lista

                // 4. Asignar el valor 0 a la variable 'i'.

                // 5. Asignar a la variable opciones todas las options de la variable 'lista'.

                // 6. Recorrer todas las opciones y asignar a la variable 'tipo' el valor (value) de la opción seleccionada.

                // 7. Sumar a la variable total la variable 'tipo.

                // 8. Mostrar en el elemento <p id="resultado"></p> el mensaje: 'Total' + total + '€'
            }
            ```
        ...
        === "SOLUCIÓN"
            ...
            function calcular() {
                ...
                // 3. Obtener el elemento <select id="habitacion"> y asignalo a la variable lista
                lista = document.querySelector("#habitacion");

                // 4. Asignar el valor 0 a la variable 'i'.
                i = 0;

                // 5. Asignar a la variable opciones todas las opciones de la variable 'lista'.
                opciones = lista.options;
                ...
                {
                    if (opciones[i].selected) {
                        tipo = parseFloat(opciones[i].value);
                    }
    ...
    ??? example "Ejercicio 2: Pedidos con extras (checkbox)"
