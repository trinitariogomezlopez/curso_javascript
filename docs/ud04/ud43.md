...
!!! note "Ejercicios 'Buscar nodos hijo'"
    ...
    ??? example "Ejercicio 3: Contar los nodos hijos de un elemento"
    ...
    ??? example "Ejercicio 4: Agenda. Detectar las citas importantes."
    ...
    ??? example "Ejercicio 5: Marcar tareas completadas"
    ...
    ??? example "Ejercicio 6: Gestión de pedidos en tienda"
        ...
        === "SOLUCIÓN"
            ...
            function calcular() {
                ...
                // 🔹 querySelectorAll → seleccionar precios
                ...
                while(i < precios.length) {
                    ...
                    // 🔹 Condición → marcar productos caros
                    if (valor > 20) {
                ...
                clientes = document.getElementsByName("cliente");
                i = 0;
                ...
                // 🔹 Condición → descuento VIP
                if (tipo === "vip") {
                    total = total * 0.9;
                }

                // 🔹 getElementById → descuento extra
                descuento = parseFloat(document.getElementById("descuento").value) || 0;

                total = total - (total * descuento / 100);

                // 🔹 children → contar productos
