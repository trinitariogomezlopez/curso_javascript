...
??? example "Ejemplo 4: Obtener los nodos hijo a partir de un nodo actual (children)"
    === "index.html"
        ...
        <html>
            <body>
                ...
                <button onclick="mostrarHijos()">Mostrar hijos</button>
            </body>
        </html>
        ```
    ...
    === "app.js"
        ...
        function mostrarHijos(){
            ...
            hijos = document.querySelector("#parrafo").children;

            alert("Número de hijos: " + hijos.length)

            while(i < hijos.length){
                alert(hijos[i].textContent);
...
!!! note "Ejercicios input: radio - checkbox - select"
    ...
    ??? example "Ejercicio 9: Compra con tipo de envío (radio)"
